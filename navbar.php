...
<nav class="navbar navbar-expand-xl navbar-light bg-light">
  <a href="index.php" class="navbar-brand"></i>TRAV<b>ELZA</b></a>
  ...
  <div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
    <div class="navbar-nav">
      ...
      <a href="pl.php" class="nav-item nav-link">Places</a>
      <div class="nav-item dropdown">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">About</a>
        <div class="dropdown-menu">
          <a href="gallery.php" class="dropdown-item">Gallery</a>
          <a href="log.php" class="dropdown-item">Loging</a>
          <!-- <a href="#" class="dropdown-item">Graphic Design</a> -->
          <!-- <a href="#" class="dropdown-item">Digital Marketing</a> --> 
        </div>
      </div>
      <a href="hotel registration.php" class="nav-item nav-link">Your Hotel</a>
      <a href="contact new.php" class="nav-item nav-link">Contact</a>
    </div>
    ...
    <div class="navbar-nav ml-auto">
      ...
      <div class="nav-item dropdown">
        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle user-action"><img src="img/hotel1.jpg" class="avatar" alt="Avatar"> Paula Wilson <b class="caret"></b></a>
        <div class="dropdown-menu">
